...
## Quick links — all TTGO Android apps on Google Play
...
## About TTGO Games / AVTFINITY

**TTGO** is a mobile game brand by **AVTFINITY** focused on free Android puzzle games, casual games, offline games, brain teasers, relaxing games, and family-friendly entertainment on Google Play.

We publish:

- **Block puzzle games** — classic block puzzle, jewel block puzzle, crystal puzzle, cat theme puzzle, line clear puzzle, Tetris-like block placement, brain training block games
- **Water sort puzzle games** — color water sort, tube sort puzzle, liquid sort, color sorting games, cat water sort, relaxing sort puzzles
- **Match & blast games** — match-3, winter blast puzzle, block blast, candy-style match blast, snowy puzzle levels
- **Mahjong & tile match** — animal mahjong, mahjong solitaire, tile matching, connect tiles, DreamTile mahjong match
- **Offline game collections** — 100 offline games, no wifi games, offline puzzle pack, mini games without internet, play offline Android games
- **Casual & brain games** — free casual Android games, IQ games, logic puzzles, relaxing free time games, stress relief games

Search keywords people use for our games: `TTGO games`, `AVTFINITY`, `free Android puzzle`, `block puzzle jewel`, `crystal cat puzzle`, `water sort cat`, `offline games no wifi`, `100 offline games`, `Winter Blast Puzzle`, `animal mahjong match`, `DreamTile`, `free games Google Play`, `puzzle games offline`, `casual brain games`, `tile puzzle`, `color sort game`, `match 3 winter`, `mahjong animal`.

---

## 1. Block Puzzle Jewel Crystal Cat
...
**Description:** Play **Block Puzzle Jewel Crystal Cat** free on Android. Place jewel blocks, clear lines, relax with cute cats, and enjoy classic brain-training puzzle gameplay. Best for fans of block puzzle games, jewel crystal puzzles, cat theme games, offline block puzzles, and free casual Android games on Google Play.

---

## 2. 100 Offline Game No Wifi
...
**Description:** Download **100 Offline Game No Wifi** free on Android. Enjoy 100+ puzzle and casual mini games playable without internet. Perfect for travel, airplane mode, weak signal areas, offline entertainment, no wifi puzzle games, and free offline game collections on Google Play.

---

## 3. Winter Blast Puzzle
...
**Description:** Play **Winter Blast Puzzle** free on Android. Match and blast colorful winter blocks, clear snowy levels offline, and enjoy relaxing match-and-blast puzzle gameplay. Ideal for match-3 fans, winter theme games, blast puzzle lovers, and free casual Android games on Google Play.

---

## 4. Cat Color Water Sort Puzzle
...
**Description:** Play **Cat Color Water Sort Puzzle** free on Android. Sort colored water into tubes, enjoy a cute cat theme, and relax with satisfying color-sort brain teasers. Great for water sort puzzle fans, color sorting games, cat theme puzzles, offline logic games, and free Google Play brain games.

---

## 5. DreamTile Animal Mahjong Match
...
**Description:** Play **DreamTile Animal Mahjong Match** free on Android. Connect animal mahjong tiles, clear relaxing levels, and enjoy a cute tile-match puzzle. Perfect for mahjong fans, animal tile match players, free mahjong Android games, and relaxing tile puzzles on Google Play.

---

## Full app URL list (copy / index friendly)

### Google Play Store links
1. https://play.google.com/store/apps/details?id=com.happyfunnypuzzle.block.jewel.crystal  
2. https://play.google.com/store/apps/details?id=com.PuzzleCollection.tiles.puzzle.Collection.Brain  
3. https://play.google.com/store/apps/details?id=com.ttgo.winter.blash  
4. https://play.google.com/store/apps/details?id=com.unfairthirty.cat.color.water.sort.puzzle  
5. https://play.google.com/store/apps/details?id=com.avt.mahjong.dreamtile.match2  
...
## SEO / discoverability keywords (GitHub search, Google, app store discovery)

`TTGO` `TTGO games` `TTGO Android` `AVTFINITY` `AVTFINITY games` `free Android games` `Google Play games` `free puzzle games` `Android puzzle games` `casual games Android` `brain games` `offline games` `no wifi games` `games without internet` `offline puzzle` `block puzzle` `jewel puzzle` `crystal puzzle` `cat puzzle` `jewel crystal cat` `Block Puzzle Jewel Crystal Cat` `water sort` `water sort puzzle` `color sort` `tube sort` `Cat Color Water Sort Puzzle` `match 3` `match and blast` `Winter Blast Puzzle` `winter puzzle` `block blast` `mahjong` `animal mahjong` `mahjong match` `tile match` `DreamTile` `DreamTile Animal Mahjong Match` `100 Offline Game No Wifi` `mini games` `relaxing games` `free time games` `logic puzzle` `tile puzzle` `color sorting game` `free games Google Play` `download Android games` `mobile puzzle` `family friendly games` `cute cat games` `snow puzzle` `blast puzzle` `solitaire mahjong` `puzzle collection` `brain training` `IQ games` `stress relief games` `play offline` `airplane mode games` `free to play Android`

---

## Game categories we cover

| Category | Related TTGO apps |
|----------|-------------------|
| Block puzzle / jewel / crystal | Block Puzzle Jewel Crystal Cat |
| Offline / no wifi / mini games | 100 Offline Game No Wifi |
| Match-3 / blast / winter | Winter Blast Puzzle |
| Water sort / color sort | Cat Color Water Sort Puzzle |
| Mahjong / tile match / animal | DreamTile Animal Mahjong Match |
...
Open `index.html` in a browser, or host the folder as a static site (GitHub Pages, Netlify, Cloudflare Pages, any static host).

### Purpose of this README

This README lists every TTGO / AVTFINITY Android app with Google Play links, website links, package IDs, genres, and keywords so the catalog is easy to find via **GitHub search**, repository discovery, and web indexing for queries like:

- free Android puzzle games  
- block puzzle jewel crystal cat  
- water sort puzzle cat  
- offline games no wifi  
- Winter Blast Puzzle  
- animal mahjong match DreamTile  
- AVTFINITY Google Play  
- TTGO games download  
...
*Free Android puzzle & casual games by TTGO / AVTFINITY — block puzzle, water sort, offline games, Winter Blast, animal mahjong — download on Google Play.*
